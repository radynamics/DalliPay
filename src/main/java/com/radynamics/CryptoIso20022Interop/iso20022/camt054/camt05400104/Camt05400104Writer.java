...
public class Camt05400104Writer implements Camt054Writer {
    ...
    private AccountNotification7 getNtfctnOrNull(Document d, Wallet receiver, String ccy) throws AccountMappingSourceException {
    ...
    private CashAccount25 createAcct(Wallet receiver, String ccy) throws AccountMappingSourceException {
