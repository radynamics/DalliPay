    ...
    private Erc20Path[] knownTokensOf(String ccy, Ledger ledger) {
        if (Stream.of("USD", "USDT", "USDC").anyMatch(o -> o.equalsIgnoreCase(ccy))) {
            return new Erc20Path[]{
                    new Erc20Path(new Currency("USDT", ledger.createWallet("0xdAC17F958D2ee523a2206206994597C13D831ec7", null))),
                    new Erc20Path(new Currency("USDC", ledger.createWallet("0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48", null))),
            };
        }

        if (Stream.of("CHF", "XCHF").anyMatch(o -> o.equalsIgnoreCase(ccy))) {
            return new Erc20Path[]{
                    new Erc20Path(new Currency("XCHF", ledger.createWallet("0xb4272071ecadd69d933adcd19ca99fe80664fc08", null))),
            };
        }
