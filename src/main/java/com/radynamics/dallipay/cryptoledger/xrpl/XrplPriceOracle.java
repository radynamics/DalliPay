...
public class XrplPriceOracle implements ExchangeRateProvider {
    ...
    private com.radynamics.dallipay.cryptoledger.Transaction getBestMatch(com.radynamics.dallipay.cryptoledger.Transaction[] transactions, ZonedDateTime pointInTime) {
