...
import com.radynamics.dallipay.iso20022.camt054.camt05300108.generated.CashAccount39;
import com.radynamics.dallipay.iso20022.camt054.camt05400102.generated.CashAccount20;
import com.radynamics.dallipay.iso20022.camt054.camt05400104.generated.CashAccount25;
import com.radynamics.dallipay.iso20022.camt054.camt05400109.generated.CashAccount41;
...
public class CashAccountCompare {
    ...
    public static boolean isSame(CashAccount39 first, CashAccount39 second) {
        return isSame(toCashAccount(first), toCashAccount(second));
    }
    ...
    private static CashAccount toCashAccount(CashAccount39 ca) {
        if (ca == null) throw new IllegalArgumentException("Parameter 'ca' cannot be null");
        return new CashAccount() {
            {
                id = ca.getId();
                ...
                nm = ca.getNm();
                tp = ca.getTp();
                tpCd = ca.getTp() == null || ca.getTp().getCd() == null ? null : ca.getTp().getCd();
                tpPrtry = ca.getTp() == null ? null : ca.getTp().getPrtry();
            }
        };
    }
