...
public class Camt05400104Writer implements Camt054Writer {
    ...
    private AccountNotification7 getNtfctnOrNull(Document d, Account receiver, String ccy) {
    ...
    private CashAccount25 createAcct(Account account, String ccy) {
    ...
    private ReportEntry4 createNtry(Payment trx, Account receiverAccount) throws DatatypeConfigurationException {
    ...
    private PartyIdentification43 createPartyIdentification(String name) {
        if (name == null) {
            return null;
        }
